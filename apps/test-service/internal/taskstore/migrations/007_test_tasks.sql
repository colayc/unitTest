...
CREATE TABLE tasks_v7 (
  ...
  kind TEXT NOT NULL CHECK (
    kind IN ('simulation','cmake_build','test_discovery','test_run')
  ),
  scenario TEXT,
  ...
  CHECK (
    ...
    (kind IN ('cmake_build','test_discovery','test_run') AND
...
CREATE TABLE task_steps_v7 (
  task_id TEXT NOT NULL REFERENCES tasks_v7(task_id) ON DELETE CASCADE,
...
ALTER TABLE task_steps_v7 RENAME TO task_steps;
