...
func reportFixture(t *testing.T) Input {
	...
	items := []testdomain.TestItemResult{
		...
		{ItemID: testID("b"), ContainerID: testID("c"), Iteration: 1, Outcome: testdomain.ItemFailed, SourceLocation: &testdomain.SourceLocation{URI: "file:///workspace/src/example.cpp", Line: 5, Column: 2, Navigable: true, Provenance: "test-declaration"}, FailureDetails: []testdomain.FailureDetail{{Category: "assertion_failure", Subtype: testdomain.FailureSubtypeMockParameterMismatch, Message: "want <safe>, got & wrong", Expected: "expected call(1)", Actual: "actual call(2)", Locations: []testdomain.SourceLocation{{URI: "file:///workspace/src/example.cpp", Line: 5, Column: 2, Navigable: true, Provenance: "framework-output"}}, EvidenceRefs: []string{strings.Repeat("d", 32)}}}, OutputRefs: []string{}},
